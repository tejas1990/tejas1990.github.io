...
function modules() {
  ...
  // Bootstrap Material
  var bootstrap_material = gulp.src('./node_modules/bootstrap-material-design/dist/**/*')
  ...
  return merge(bootstrap, bootstrap_material, popper, fontAwesomeCSS, fontAwesomeWebfonts, jquery, jqueryEasing);
}
...
function compile() {
  ...
  // CSS
  var css = gulp.src('./css/*').pipe(gulp.dest('./dist/css'));
  // JS
  ...
  return merge(html, css, js, img, vendor);
}
...
const build = gulp.series(clean, modules, compile);
